...
function Home() {
  ...
  return (
    <>
      ...
      <div className="bg-black text-white min-vh-100" style={{ paddingTop: "110px", paddingLeft: "20px" }}>
        {/* SEARCH BAR CENTER */}
        <div className="d-flex justify-content-center mb-4" style={{ marginTop: "-40px" }}>
          <div className="input-group" style={{ maxWidth: "400px" }}>
            ...
            <button className="btn" type="button" style={{
              ...
              <i className="fa-solid fa-magnifying-glass" style={{ color: "white", fontWeight: "600", backgroundColor:"#e85d26" }}></i>
            </button>
          </div>
        </div>

        <div className="ms-lg-5" style={{ marginLeft: "10%" }}>
        ...
        <h2 className="text-white mt-4 text-center fw-bold">
          Showing:{" "}
            ...
            filteredBySearch.map((item) => (
              ...
              >
                ...
                <div className="card-body">
                  ...
                  <p className="card-text text-secondary">By: {item.instructor}</p>
                  <p className="card-text text-secondary">Duration: {item.duration}</p>
